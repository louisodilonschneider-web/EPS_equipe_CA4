...
Neuf préréglages sont livrés, répartis en deux familles :
...
**Attendus de fin de cycle** est ta bibliothèque : tu écris tes attendus, dans tes mots, et
l'application les relie aux items.
...
délie. Les mêmes attendus ne sont donc pas proposés à une classe de sixième et à une classe de
...
npm i playwright && node test/browser.js   # parcours complet dans Chromium (96 vérifications)
